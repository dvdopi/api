...
$app->group('/api', function () use ($app) {
    ...
    $app->group('/v1', function () use ($app) {
	 ...
	 $app->group('/v2', function () use ($app) {
		$app->get('/leaveType', 'getLeaveType');
		$app->get('/leaveSummary/{id}', 'getLeaveSummary');
		$app->get('/leaveRequest/{id}', 'getLeaveRequest');
		$app->get('/employeeLeaveStatus/{id}', 'getEmployeeLeaveStatus');
		
		$app->post('/apply', 'addLeave');
	});
});
